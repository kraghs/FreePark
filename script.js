document.addEventListener('DOMContentLoaded', function() {
  const parkingSpots = [
    ...
    // Helsingør
    {name:"Jernbanevej P‑plads", address:"Jernbanevej, 3000 Helsingør", lat:56.0390, lng:12.6130, note:"Gratis parkering 2 timer / gratis uden for tidsrum – tjek skilte"}  /* :contentReference[oaicite:3]{index=3} */,
    {name:"Nordhavn Midter Mole", address:"Nordhavnsvej, 3000 Helsingør", lat:56.0425, lng:12.6080, note:"Fri parkering – kystnær havneplads"}  /* :contentReference[oaicite:4]{index=4} */,
    // København (som før, men kan udvides)
